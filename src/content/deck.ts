      ...
      concerns: [
        {
          ...
          description:
            "Yes, that's true—we're aware this is our biggest risk.\n\nWe've proactively engaged potential competitors. Recently at Y Combinator, we spoke with Tavus (a YC company) about their product and market vision. For now, they prefer users specialize in use cases rather than doing it themselves.\n\nThat being said, we are sure the technology will be at some point a commodity, which in any case will help us to decrease our OPEX.\n\nWhat cannot be commoditized is the moat you build as you specialize on a use case. For the past 3 weeks we have moved fast to acquire clients in which we can build a switching cost as we save the data from the conversations and integrate with other tools in their workflows.\n\nSo far our clients have been startups using us for customer support, real-life experiences (this one has no moat) and we have two contacts that landed us the contacts to be negotiating with corps like KFC, McDonalds, and similar in Central America where we can build a deep integration.\n\nThe bigger the switching cost, the more difficult it becomes for anyone to enter.",
        },
        {
          title:
